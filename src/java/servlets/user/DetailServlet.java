...
import jaxb.newsimage.ListImages;
...
//        listImages.getImage().addAll(newsItem.getImageList());
        request.setAttribute("id", id);
        RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/WEB-INF/jsp/detail.jsp");
